...
//       className={cn(
//         "flex items-center",
//         mobile ? "flex-col items-start gap-6" : "gap-9",
//         className
//       )}
//       variants={{
//         open: { opacity: 1, y: 0 },
...
//             }
//             className={cn(
//               "cursor-pointer text-base transition-all duration-300",
//               mobile
//                 ? "text-2xl font-semibold hover:text-blue-400"
//                 : "hover:text-blue-400"
//             )}
//             onClick={onClick}
//           >
...
//   const navVariants = {
//     top: { backgroundColor: "rgba(4, 7, 16, 0)", backdropFilter: "blur(0px)" },
//     scrolled: {
...
//         <Link href="/">
//           <Image
//             className="cursor-pointer object-contain transition-all duration-300 ease-in-out h-[29px] w-[33px] lg:h-[77px] lg:w-[89px]"
...
//         {isMobileMenuOpen && (
//           <motion.div
//             className="lg:hidden fixed inset-0 z-50 bg-[#040710] bg-opacity-95 flex items-center justify-center"
