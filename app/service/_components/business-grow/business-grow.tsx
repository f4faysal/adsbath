...
import businessImage from "@/assets/AdsBath/business-grow.png";
    ...
    <section className="py-16 px-6">
      <div className="w-[50%] mx-auto my-10">
        <h1 className="text-3xl md:text-4xl font-bold leading-snug text-center">
          Hi, We’re Grow My Ads, and we help businesses just like yours double,
          triple, or even 10x results
        </h1>
        <p className="text-center mt-5">
          We’re tired of all the empty promises from companies in the PPC
          industry, so we’re setting out on a different path. Our 90-Day Growth
          Sprints take a proactive, hands-on approach to help you make more
          money with
        </p>
      </div>
